...
tpot = TPOTRegressor(verbosity=3, scoring = rmsle_loss,periodic_checkpoint_folder='C:\\Users\\jstnjc\\Google Drive\\Kaggle\\Advanced House Prices\\NoEng200_outliers1st', population_size=300,offspring_size= 400,max_eval_time_mins=10, use_dask=True)
tpot.fit(X_train,y_train)

eval_pareto = tpot.pareto_front_fitted_pipelines_
output2 = open('C:\\Users\\jstnjc\\Google Drive\\Kaggle\\Advanced House Prices\\NoEng200_outliers1st\\eval_pareto.pkl','wb')
