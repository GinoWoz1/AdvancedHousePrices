...
tpot = TPOTRegressor(verbosity=3, scoring = rmsle_loss,periodic_checkpoint_folder='C:\\Users\\jstnjc\\Google Drive\\Kaggle\\Advanced House Prices\\NoEng178_outliers1st', population_size=300,offspring_size= 400,max_eval_time_mins=10, use_dask=True)
